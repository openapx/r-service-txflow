...
Rscript -e "install.packages( c( \"sodium\", \"openssl\", \"plumber\", \"jsonlite\",  \"digest\", \"uuid\", \"httr2\", \"base64enc\", \"xml2\" ), type = \"source\", destdir = \"/sources/R-packages\" )" >> /logs/openapx/txflow/install-r-packages.log 2>&1
